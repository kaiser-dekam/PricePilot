          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <Select value={saleStatus} onValueChange={handleSaleStatusChange}>
                  <SelectTrigger className="w-full sm:w-48">
                    <SelectValue placeholder="Sale Status" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">All Products</SelectItem>
                    <SelectItem value="on_sale">Products on Sale</SelectItem>
                    <SelectItem value="not_on_sale">Products Not on Sale</SelectItem>
                  </SelectContent>
                </Select>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">
                {search || category !== "all" || saleStatus !== "all" ? "Try adjusting your filters" : "Sync products from BigCommerce to get started"}
              </p>
              {!search && category === "all" && saleStatus === "all" && (
