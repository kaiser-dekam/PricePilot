      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <Link href="/signin">
            <Button 
              size="lg"
              className="text-base sm:text-lg px-6 sm:px-8 py-2 sm:py-3 w-full sm:w-auto max-w-xs"
            >
              Sign Up / Sign In
            </Button>
          </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12 sm:mb-16">
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg text-center">
            <ShoppingCart className="h-10 w-10 sm:h-12 sm:w-12 text-blue-600 mx-auto mb-3 sm:mb-4" />
          ...
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg text-center">
            <BarChart3 className="h-10 w-10 sm:h-12 sm:w-12 text-green-600 mx-auto mb-3 sm:mb-4" />
            <h3 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">
              Bulk Price Updates
            </h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg text-center">
            <Clock className="h-10 w-10 sm:h-12 sm:w-12 text-purple-600 mx-auto mb-3 sm:mb-4" />
            <h3 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">
          ...
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg text-center">
            <Shield className="h-10 w-10 sm:h-12 sm:w-12 text-red-600 mx-auto mb-3 sm:mb-4" />
            <h3 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">
              Secure & Reliable
            </h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
